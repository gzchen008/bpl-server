...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/tucao/bplTucao/">吐槽流水记录列表</a></li>
		<li class="active"><a href="${ctx}/tucao/bplTucao/form?id=${bplTucao.id}">吐槽流水记录<shiro:hasPermission name="tucao:bplTucao:edit">${not empty bplTucao.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="tucao:bplTucao:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="bplTucao" action="${ctx}/tucao/bplTucao/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="tucao:bplTucao:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
